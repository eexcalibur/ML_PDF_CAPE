...
!
   ...
   if( cam_physpkg_is('cam3')) then
      ...
      !    The differewnce of CAPE values from the two calls is DCAPE, based on the same launch level
         ...
         ! ml cape
         call cpu_time(start)
         tmp = cape_ml_c(t,p,q, cape_m)
         call cpu_time(finish)
         print *, "time in fortran ", finish - start
...
! ml cape pdf zhangtao
!print *, "dcape", dcape
!cape_pdf = cape_ml_c(t,p,q)
!print *, "cape_pdf: ", cape_pdf
!call exit(0)
